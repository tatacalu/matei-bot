...
public class RepositoryCommentsRestController {
    ...
    public void receiveGithubWebhookIssueCommentEvent(@RequestBody String requestBody, @RequestHeader  Map<String, String> requestHeaders) {

        LOGGER.info("GitHub issue_comment webhook event received! Headers: {}, Body: {}", requestHeaders, requestBody);
    }
}
